...
class Calcular:
    ...
    def __init__(self: object, dificuldade: int) -> None:
        ...
        self.__valor1: int = self._trazer_valor
        self.__valor2: int = self._trazer_valor
        self.__operacao: int = randint(1, 3)  # 1= somar,2=diminuir,3=multiplcar
        self.__resultado: int = self._trazer_resultado
    ...
    @property
    def _trazer_valor(self: object) -> int:
    ...
    @property
    def _trazer_resultado(self: object) -> int:
        if self.operacao == 1:
